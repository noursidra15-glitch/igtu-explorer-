...
const guides = [
  {
    ...
    description: "Official Student Guide Available",
    icon: Map,
  ...
  },
  {
    ...
    description: "Official Student Guide Available",
    icon: Building2,
    read: "/guides/Architecture/architecture_guide_igtu_reference_style.html",
    pdf: "/guides/Architecture/architecture_guide_igtu_reference_style.pdf",
  },
  {
    title: "Urban Engineering",
    description: "Official Student Guide Available",
    icon: Landmark,
    read: "/guides/Urban Engineering/genie_urbain_guide_igtu_reference_style.html",
    pdf:"/guides/Urban Engineering/genie_urbain_guide_igtu_reference_style.pdf",
  },
  {
    title: "City Management",
    description: "Official Student Guide Available",
    icon: Building,
    read:"/guides/City Management/gestion_villes_guide_igtu_reference_style.html",
    pdf: "/guides/City Management/gestion_villes_guide_igtu_reference_style.html",
  },
  {
  ...
  {
    title: "Socle Commun GTU",
    description: "Official Student Guide Available",
    icon: Building,
    read: "/guides/Socle Commun GTU/socle_commun_guide_igtu_reference_style.html",
    pdf: "/guides/Socle Commun GTU/socle_commun_guide_igtu_reference_style.html",
  },
];
